...
*   **Task DEV-1.1: Component & Routing Initialization**
    *   **Description**: Follow the standard folder structure (DevWorkspace framework). Create the Angular Component `regex-tester`. Import it into the router module. Configure the sidebar menu.
